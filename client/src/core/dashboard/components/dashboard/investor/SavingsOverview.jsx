  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-2 lg:w-auto p-2 ">
        <div
          className="w-20 h-20 bg-gray-300 text-secondary rounded-full flex items-center justify-center radial-progress"
          style={{
            "--value": progressValue,
            "--size": "5rem",
            "--thickness": "0.4rem",
      ...
      <div className="flex-1 w-full lg:w-auto">
        <div className="flex items-center gap-2">
          <DollarCircle size="36" className="text-secondary" />
