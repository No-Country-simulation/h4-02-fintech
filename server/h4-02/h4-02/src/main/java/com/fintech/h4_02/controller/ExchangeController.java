...
public class ExchangeController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Get list of all coins",
                    content = @Content(
    ...
    @Operation(summary = "Get price of coin")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Get a coin",
                    content = @Content(
                            mediaType = MediaType.APPLICATION_JSON_VALUE,
    ...
    @Operation(summary = "Get description of a coin")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Get coin description successfully",
                    content = @Content(
                            mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(implementation = JsonNode.class),
                            examples = @ExampleObject(
    ...
    public ResponseEntity<JsonNode> getCoinDescription(@RequestParam String coin) throws JsonProcessingException {
        return ResponseEntity.status(HttpStatus.OK).body(exchangeService.getCoinDescription(coin));
    }

    @Operation(summary = "Buy a coin")
    @ApiResponses({
    ...
    @PostMapping
    public ResponseEntity<ExchangeResponse> crateExchange(@RequestBody @Valid ExchangeRrequest exchangeRequest) {
        return ResponseEntity.status(HttpStatus.CREATED).body(exchangeService.create(exchangeRequest));
    }

    @Operation(summary = "Sell  coin")
    @ApiResponses({
    ...
    @Operation(summary = "Get history exchange by user")
    @ApiResponses({
